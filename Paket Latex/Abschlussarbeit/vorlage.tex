...
\begin{document}
%------------------------- Titelblatt -------------------------------------
\title{Konstruktion und Implementierung eines prototypischen 3D-Linien-Laserscanners}
...
%--------------------------------------------------------------------------
\supervisor{Professor Dr.-Ing. Jörg Lohscheller} 		% Betreuer der Arbeit
...
\input{chapters/DasVerfahrenInDerTheorie}
